...
function buildPlayerCard(j) {
    ...
    const instaButton = j.instagram ? `
        <a href="https://instagram.com/${j.instagram.replace('@', '')}" target="_blank" rel="noopener noreferrer" class="player-card__insta" aria-label="Instagram de ${j.nome_display}">
            ...
            ${j.instagram.startsWith('@') ? j.instagram : '@' + j.instagram}
        </a>
    ` : '';
